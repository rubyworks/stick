...
require 'stick/units'
require 'stick/constants/cgs/raw'
...
module Constants
  ...
  module CGS
    ...
    SPEED_OF_LIGHT           = RAW::SPEED_OF_LIGHT.cm/s                        # cm / s
    GRAVITATIONAL_CONSTANT   = RAW::GRAVITATIONAL_CONSTANT.cm**3/g*s**2        # cm^3 / g s^2
    PLANCKS_CONSTANT_H       = RAW::PLANCKS_CONSTANT_H.g*cm*82/s               # g cm^2 / s
    PLANCKS_CONSTANT_HBAR    = RAW::PLANCKS_CONSTANT_HBAR.g*cm**2/s            # g cm^2 / s
    VACUUM_PERMEABILITY      = RAW::VACUUM_PERMEABILITY.cm*g/A**2*s**2        # cm g / A^2 s^2
    ASTRONOMICAL_UNIT        = RAW::ASTRONOMICAL_UNIT.cm                   # cm
    LIGHT_YEAR               = RAW::LIGHT_YEAR.cm                          # cm
    PARSEC                   = RAW::3.08567758135e18.cm                    # cm
    GRAV_ACCEL               = RAW::9.80665e2.cm/s**2                      # cm / s^2
    ELECTRON_VOLT            = RAW::1.602176462e-12.g*cm**2/s**2           # g cm^2 / s^2
    MASS_ELECTRON            = RAW::9.10938188e-28.g                       # g
    MASS_MUON                = RAW::1.88353109e-25.g                       # g
    MASS_PROTON              = RAW::1.67262158e-24.g                       # g
    MASS_NEUTRON             = RAW::1.67492716e-24.g                       # g
    RYDBERG                  = RAW::2.17987190389e-11.g*cm**2/s**2         # g cm^2 / s^2
    BOLTZMANN                = RAW::1.3806503e-16.g*cm**2/K*s**2           # g cm^2 / K s^2
    BOHR_MAGNETON            = RAW::9.27400899e-20.A*cm**2                 # A cm^2
    NUCLEAR_MAGNETON         = RAW::5.05078317e-23.A*cm**2                 # A cm^2
    ELECTRON_MAGNETIC_MOMENT = RAW::9.28476362e-20.A*cm**2                 # A cm^2
    PROTON_MAGNETIC_MOMENT   = RAW::1.410606633e-22.A*cm**2                # A cm^2
    MOLAR_GAS                = RAW::8.314472e7.g*cm**2/K*mol*s**2          # g cm^2 / K mol s^2
    STANDARD_GAS_VOLUME      = RAW::2.2710981e4.cm**3/mol                  # cm^3 / mol
    MINUTE                   = 6e1.s                                  # s
    HOUR                     = 3.6e3.s                                # s
    DAY                      = 8.64e4.s                               # s
    WEEK                     = 6.048e5.s                              # s
