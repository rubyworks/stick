...
module Units
  ...
  module AU
    ...
    # Special subclass of Unit to make it easier to
    # define derived standard units.
    #
    # TODO: perhaps make a module instead?
    ...
    class Unit < Stick::Unit
      ...
      def to_au
        Measure.new(self.class.new(power))
      end
