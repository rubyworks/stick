...
module Math
  ...
  # Same as <code>Math::PI</code> - Ludolph's number, <code>Extmath.PI = 3.141_59..</code>.
  PI = Math::PI
  ...
  # Same as <code>Math.atan(+x+)</code> - arcus tangens of +x+
  def atan(x)
    Math.atan(x)
  end

  # Same as <code>Math.atan2(+x+, +y+)</code> - arcus tangens of +x+ over
  # +y+
  def atan2(x, y)
    Math.atan2(x, y)
  end
  ...
  #=begin
  #--- Extmath.sin(x)
  #    Same as <code>Math.sin(+x+)</code> - sinus of +x+
  #=end
  #def sin(x)
  #  Math.sin(x)
  #end
  ...
  #--- Extmath.sinh(x)
  #    Same as <code>Math.sinh(x)</code> - sinus hyperbolicus of +x+
  #=end
  #def sinh(x)
  #  Math.sinh(x)
  #end
